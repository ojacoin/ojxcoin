...
In order to support loading of multiple wallets in ojx-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ojx.cpp.
...
ojx.cpp is the entry point into ojx-qt, and as such, will require some minor modifications to provide hooks for
