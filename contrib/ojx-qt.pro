...
RESOURCES += src/qt/ojx.qrc src/qt/ojx_locale.qrc

TRANSLATIONS += src/qt/locale/ojx_bg.ts \
                src/qt/locale/ojx_de.ts \
                src/qt/locale/ojx_en.ts \
                src/qt/locale/ojx_es.ts \
                src/qt/locale/ojx_fi.ts \
                src/qt/locale/ojx_fr.ts \
                src/qt/locale/ojx_it.ts \
                src/qt/locale/ojx_ja.ts \
                src/qt/locale/ojx_pl.ts \
                src/qt/locale/ojx_pt.ts \
                src/qt/locale/ojx_ru.ts \
                src/qt/locale/ojx_sk.ts \
                src/qt/locale/ojx_sv.ts \
                src/qt/locale/ojx_vi.ts \
                src/qt/locale/ojx_zh_CN.ts \
                src/qt/locale/ojx_zh_TW.ts