...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ojx features */
        {"ojx", "masternode", &masternode, true, true, false},
        {"ojx", "masternodelist", &masternodelist, true, true, false},
        {"ojx", "mnbudget", &mnbudget, true, true, false},
        {"ojx", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"ojx", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ojx", "mnsync", &mnsync, true, true, false},
        {"ojx", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"ojx", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ojxd, or the -server option to ojx-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> ojx-cli " + methodname + " " + args + "\n";
}
