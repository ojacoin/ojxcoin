                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("OJA Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ojx address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ojx:URIs)"));
...
*/
    ...
    aboutAction = new QAction(QIcon(":/icons/info_menu"), tr("&About OJA Coin"), this);
    aboutAction->setStatusTip(tr("Show information about OJA Coin"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ojx"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ojx addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/verify_menu"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ojx addresses"));
    ...
    openAction->setStatusTip(tr("Open a ojx:URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the OJA Coin help message to get a list with possible ojx command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("OJA Coin client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ojx network", "", count));
}
...
{
    QString strTitle = tr("OJA Coin"); // default title
